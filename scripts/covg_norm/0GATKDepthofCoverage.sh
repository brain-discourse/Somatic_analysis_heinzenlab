...
#coverage
jobid1=$(sbatch -t 2- -n 20 -N 1 --output=/$OUTPUT_DIR/$SAMPLE_NAME/${SAMPLE_NAME}.CHRcoverage.out --mem=20g -p general -J CHRcoverage --wrap="gatk DepthOfCoverage \
...
#coverage
jobid1=$(sbatch -t 2- -n 20 -N 1 --output=/$OUTPUT_DIR/$SAMPLE_NAME/${SAMPLE_NAME}.coverage.out --mem=20g -p general -J coverage --wrap="gatk DepthOfCoverage \
